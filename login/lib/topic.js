...
function authIsOwner(request,response){
    ...
    if(cookies.email==="homelala@naver.com" && cookies.password==="1111"){
        isOwner=true;  
    }
    return isOwner;
}
...
exports.login = function(request,response){
    db.query('select * from topic',function(err,topics){
        ...
        var html =template.html(title,list,
            ...
            <p><input type="passward" name ="passwd" placeholder="passward"></p>
...
exports.login_process = function(request,response){
    var body = '';
      ...
      request.on('end', function(){
          var post = qs.parse(body);
          if(post.email === 'homelala@naver.com' && post.passwd === '1111') {
